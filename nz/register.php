...
<body style="background-color: #eeeeee">
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color: #a30059ff">
    <div class="container">
    ...
    <div id="login-form">
        <form method="post" autocomplete="off">
            ...
            <div class="col-md-12">
                ...
                <div class="checkbox">
                    <label><input type="checkbox" id="TOS" value="This"><a href="#" style="color: #a30059ff">I agree with
                            terms of service</a></label>
                </div>

                <div class="form-group">
                    <button type="submit" class="btn    btn-block btn-primary" name="signup" style="background-color:#a30059ff; " id="reg">Register</button>
                </div>
